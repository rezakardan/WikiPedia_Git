...
class FragmentTrend:Fragment() ,TrendAdapter.TrendEvents{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val trendData= arrayListOf<TrendData>(
            ...
            TrendData(
                ...
                true,
                "+1 M",
                adressUrl = "https://en.wikipedia.org/wiki/John_Madden"
            ...
            TrendData(
                ...
                true,
                "+362 K",
                adressUrl = "https://en.wikipedia.org/wiki/Don%27t_Look_Up"
            ...
            TrendData(
                ...
                true,
                "+326 K",
                adressUrl = "https://en.wikipedia.org/wiki/Harry_Reid"
            ...
            TrendData(
                ...
                true,
                "+302 K",
                adressUrl = "https://en.wikipedia.org/wiki/Spider-Man:_No_Way_Home"
            ...
            TrendData(
                ...
                true,
                "+198 K",
                adressUrl = "https://en.wikipedia.org/wiki/The_Matrix_Resurrections"
            ...
            TrendData(
                ...
                true,
                "+344 K",
                adressUrl = "https://en.wikipedia.org/wiki/Margaret_Campbell,_Duchess_of_Argyll"
            ...
            TrendData(
                ...
                true,
                "+164 K",
                adressUrl = "https://en.wikipedia.org/wiki/Encanto"
            ...
            TrendData(
                ...
                true,
                "+430 K",
                adressUrl = "https://en.wikipedia.org/wiki/Boxing_Day"
            ...
            TrendData(
                ...
                true,
                "+372 K",
                adressUrl = "https://en.wikipedia.org/wiki/James_Webb_Space_Telescope"
        ...
        val myAdapter=TrendAdapter(trendData,this)
        binding.recyclertrend.adapter=myAdapter
        binding.recyclertrend.layoutManager=LinearLayoutManager(context,LinearLayoutManager.VERTICAL,false)


    }

    override fun onTrendItemClicked(trend: TrendData) {
        val intent=Intent(context,MainActivity2::class.java)
        intent.putExtra("trendItem",trend)
